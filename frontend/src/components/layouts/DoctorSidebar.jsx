...
export const DoctorSidebar = ({ isOpen, onClose }) => {
  const navItems = [
    ...
    { icon: <Plus />, label: 'New Consultation', id: 'upload', link: '/upload' },
    { icon: <Clock />, label: 'Pending Reviews', id: 'pending', link: '/dashboard', badge: 5 },
    { icon: <Users />, label: 'Manage Patients', id: 'patients', link: '/doctor/patients' },
    { icon: <FileText />, label: 'Reports', id: 'reports', link: '/dashboard' },
